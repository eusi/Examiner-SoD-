...
LibGearExam.Patterns = {
	...
	{ p = "提高神聖法術能量(%d+)點。", s = "HOLYDMG" },	
		...
		-- SoD Phase 8 更新 (zhTW)
	{ p = "使你所有法術和攻擊的致命一擊機率提高(%d+)%%%。", s = { "CRIT" }},
	{ p = "使你所有法術和攻擊的命中機率提高(%d+)%%%。", s = { "HIT" }},
	{ p = "使你的施法速度提高(%d+)%%%。", s = { "SPELLHASTE" }},
	{ p = "使所有魔法法術和效果所造成的治療效果最多提高(%d+)，傷害效果最多提高(%d+)點%." , s = { "HEAL", "SPELLDMG" } },
	{ p = "神聖化", s = "SANCTIFIED" },
	{ p = "血色制服", s = "SANCTIFIED" },
	{ p = "組合: 將黎明聖印加成視作為穿戴 2 件額外沐聖護甲。（裝備超過 8 件沐聖護甲不會提供額外效果）", s = "SANCTIFIED-SET" },
	{ p = "攻擊速度提高(%d+)%%。", s = { "HASTE" }},
	{ p = "使你的攻擊被閃躲或招架的機率降低(%d+)%%。", s = { "EXPERTISE" }},
