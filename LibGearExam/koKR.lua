...
--]]
	...
	-- SoD Phase 8 업데이트 (koKR)
	{ p = "모든 주문 및 공격의 치명타 적중 확률이 (%d+)%%만큼 증가합니다%.", s = { "CRIT" }},
	{ p = "모든 주문 및 공격의 적중 확률이 (%d+)%%만큼 증가합니다%.", s = { "HIT" }},
	{ p = "주문 시전 속도가 (%d+)%%만큼 증가합니다%.", s = { "SPELLHASTE" }},
	{ p = "모든 주문 및 효과로 인한 치유량이 최대 (%d+), 피해량이 최대 (%d+)만큼 증가합니다%." , s = { "HEAL", "SPELLDMG" } },
	{ p = "신성화됨", s = "SANCTIFIED" },
	{ p = "붉은십자군 제복", s = "SANCTIFIED" },
	{ p = "세트 : 여명의 문장 추가 효과를 축성 아이템 2개를 추가로 착용한 것으로 간주합니다. 축성 아이템을 8개 넘게 착용해도 이로운 효과가 추가로 부여되지는 않습니다.", s = "SANCTIFIED-SET" },
	{ p = "공격 속도가 (%d+)%%만큼 증가합니다.", s = { "HASTE" }},
	{ p = "자신의 공격이 회피되거나 막힐 확률이 (%d+)%%만큼 감소합니다.", s = { "EXPERTISE" }},
