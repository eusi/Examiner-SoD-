...
LibGearExam.Patterns = {
	...
	-- SoD Phase 8 Обновление (ruRU)
	{ p = "Повышает вероятность критического удара всеми заклинаниями и атаками на (%d+)%%%.", s = { "CRIT" }},
	{ p = "Повышает вероятность попадания всеми заклинаниями и атаками на (%d+)%%%.", s = { "HIT" }},
	{ p = "Увеличивает скорость произнесения заклинаний на (%d+)%%%.", s = { "SPELLHASTE" }},
	{ p = "Увеличивает исцеление до (%d+) и урон до (%d+), наносимые всеми магическими заклинаниями и эффектами%." , s = { "HEAL", "SPELLDMG" } },
	{ p = "Освященный", s = "SANCTIFIED" },
	{ p = "Алый мундир", s = "SANCTIFIED" },
	{ p = "Набор: Печать Рассвета дает вам дополнительный бонус, как если бы вы использовали еще 2 освященных предмета:освященных предметов снаряжения. Освященные предметы после 8-го не дают дополнительных бонусов.", s = "SANCTIFIED-SET" },
	{ p = "Увеличивает скорость атаки на (%d+)%%.", s = { "HASTE" }},
	{ p = "Снижает вероятность уклонения или парирования ваших атак на (%d+)%%.", s = { "EXPERTISE" }},
