...
LibGearExam.Patterns = {
	...
	-- SoD Phase 8 Update
	{ p = "Повышает шанс нанести критический удар всеми заклинаниями и атаками на (%d+)%%%.", s = { "CRIT" }},
	{ p = "Повышает шанс попадания всеми заклинаниями и атаками на (%d+)%%%.", s = { "HIT" }},
	{ p = "Увеличивает скорость произнесения заклинаний на (%d+)%%%.", s = { "HASTE" }},
	{ p = "Увеличивает лечение до (%d+) и урон до (%d+) от всех магических заклинаний и эффектов%." , s = { "HEAL", "SPELLDMG" } },
	{ p = "Освящённый", s = "SANCTIFIED" },
	{ p = "Форма Алого ордена", s = "SANCTIFIED" },
	{ p = "Эффект печати Рассвета действует так, как если бы вы носили ещё 2 дополнительных освящённых предмета.", s = "SANCTIFIED-SET" },
