...
LibGearExam.Patterns = {
	...
	{ p = "Увеличивает скорость произнесения заклинаний на (%d+)%%%.", s = { "HASTE" }},
	...
	{ p = "рассматривает ваш бонус от печати рассвета как если бы вы носили еще 2 освященных предмета.", s = "SANCTIFIED-SET" },
