...
LibGearExam.Patterns = {
	...
	{ p = "提高神圣法术和效果所造成的伤害，最多(%d+)点。", s = "HOLYDMG" },
		...
		-- SoD Phase 8 更新 (zhCN)
	{ p = "使你所有法术和攻击的致命一击几率提高(%d+)%%%。", s = { "CRIT" }},
	{ p = "使你所有法术和攻击的命中几率提高(%d+)%%%。", s = { "HIT" }},
	{ p = "使你的施法速度提高(%d+)%%%。", s = { "SPELLHASTE" }},
	{ p = "使所有魔法法术和效果所造成的治疗效果最多提高(%d+)，伤害效果最多提高(%d+)点%." , s = { "HEAL", "SPELLDMG" } },
	{ p = "神圣化", s = "SANCTIFIED" },
	{ p = "血色制服", s = "SANCTIFIED" },
	{ p = "组合: 将你的黎明圣印增益效果视为额外装备了2件圣化护甲。（若装备的圣化护甲超过8件，则无法再额外获得增益效果）", s = "SANCTIFIED-SET" },
	{ p = "攻击速度提高(%d+)%%。", s = { "HASTE" }},
	{ p = "使你的攻击被躲闪或招架的几率降低(%d+)%%。", s = { "EXPERTISE" }},
